...
training$Experience <- scale(training$Experience)
training$Income <- scale(training$Income)
training$Family <- scale(training$Family)
training$CCAvg <- scale(training$CCAvg)
training$Mortgage <- scale(training$Mortgage)
...
# KNN Model using Class::knn3

knn_model_1 <- knn3(`Personal Loan`~., data = training, k = 1)
