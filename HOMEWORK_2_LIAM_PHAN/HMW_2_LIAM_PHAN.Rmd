...
for(i in 1:iterations){
  # Testing K-NN
  knn.prediction <- knn(train = training_norm[,-c("Personal Loan")], test=validation_norm[,-c("Personal Loan")] , cl=training_norm$`Personal Loan`, k=iterations)
...
$$P(Loan=1 | CC=1 \cap Online=1) =  \\ \dfrac{P(Loan=1 \cap CC=1 \cap Online=1)}{P(CC=1 \cap Online=1)} = \\ \dfrac{\dfrac{54}{3050}}{\dfrac{506+54}{3050}} =\dfrac{54}{560} = 9.642 \% $$
...
$$P (CC=1 | Loan=1) = \\ \dfrac{P (CC=1 \cap Loan=1)}{P (Loan=1)} = \\ \dfrac{95}{297} = 31.99 \%  $$

#### ii.

$$P (Online=1 | Loan=1) = \\ \dfrac{P (Online=1 \cap Loan=1)}{P (Loan=1)} = \\ \dfrac{188}{297} = 63.30 \%$$

#### iii.

$$P (Loan=1) =  \dfrac{297}{3050} = 9.74 \%$$

#### iv.

$$P (CC=1 | Loan=0) = \\ \dfrac{P (CC=1 \cap Loan=0)}{P (Loan=0)} = \\ \dfrac{827}{2753} = 30.04 \%$$

#### v.

$$P (Online=1 | Loan=0) = \\ \dfrac{P (Online=1 \cap Loan=0)}{P (Loan=0)} = \\ \dfrac{1626}{2753} = 59.06 \%$$

#### vi.

$$P (Loan=0) = \dfrac{2753}{3050} =  90.26\%$$
