...
> Since all Confusion Matrices give a bad Specificity Rate (lower than 0.8), I would not rely in this model too much when it comes to predicting the Customer getting Loan. This K-NN model give more No Loan correctly than the opposite. 
